...
public abstract class Map extends StructureObject{
	 ...
	 * @return a boolean value signifying the a's presence<br><code>true</code> if the actor is within borders
	 * <br><code>false</code> if the actor is not within borders
	 */
